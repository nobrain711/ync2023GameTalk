...
@SpringBootTest
class DlcRepostioryTest {
    @Autowired
    GameRepostiory gameRepostiory;

    @Autowired
    DlcRepostiory dlcRepostiory;

    @Test
    void testInsert(){
        DlcEntity dlc = DlcEntity
                .builder()
                .game(gameRepostiory.findByTitle("Assassin's Creed Valhalla"))
        ...
        dlcRepostiory.save(dlc);
    }

    @Test
    void testShow(){
        List<Object[]> dlc = dlcRepostiory.findByDlcId(1L);
